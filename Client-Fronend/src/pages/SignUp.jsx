    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-50">
      <div className="bg-white border border-gray-200 rounded-xl p-8 w-full max-w-md">
        ...
        <div className="mb-4">
          ...
          <input type="text" name="name" value={details.name} onChange={handleInput}
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          ...
          <span onClick={() => navigate('/login')} className="text-emerald-600 font-medium cursor-pointer">Login</span>
        </p>
      </div>
    </div>
  )
